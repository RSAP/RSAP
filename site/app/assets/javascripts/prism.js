...
! function(a) {
	...
	}), a.languages.flow["function-variable"].pattern = /[_$a-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*(?=\s*=\s*(?:function\b|(?:\([^()]*\)(?:\s*:\s*\w+)?|[_$a-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*)\s*=>))/i, a.languages.insertBefore("flow", "operator", {
		"flow-punctuation": {
			pattern: /\{\||\|\}/,
			alias: "punctuation"
		}
	}), "Array" !== a.util.type(a.languages.flow.keyword) && (a.languages.flow.keyword = [a.languages.flow.keyword]), a.languages.flow.keyword.unshift({
...
! function(e) {
	e.languages.erb = e.languages.extend("ruby", {}), e.languages.insertBefore("erb", "comment", {
		...
		var n = /<%=?[\s\S]+?%>/g;
		e.languages["markup-templating"].buildPlaceholders(a, "erb", n)
...
! function(e) {
	e.languages.smarty = {
		...
		var a = /\{\*[\s\S]*?\*\}|\{[\s\S]+?\}/g,
			...
			o = "{/literal}",
			r = !1;
		e.languages["markup-templating"].buildPlaceholders(t, "smarty", a, function(e) {
			return e === o && (r = !1), r ? !1 : (e === n && (r = !0), !0)
		})
...
! function(e) {
	...
	e.languages.soy = {
		...
		var t = /{{.+?}}|{.+?}|\s\/\/.*|\/\*[\s\S]*?\*\//g,
			...
			l = "{/literal}",
			r = !1;
		e.languages["markup-templating"].buildPlaceholders(a, "soy", t, function(e) {
			return e === l && (r = !1), r ? !1 : (e === n && (r = !0), !0)
		})
	}), e.hooks.add("after-tokenize", function(a) {
